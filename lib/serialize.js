...
async function serialize(msg, conn) {
  ...
  msg.sendContact = async (jid, contact, nm, quoted = false, opts = {}) => {
    let list = [];
  ...
  if (msg.message) {
    ...
    msg.adReply = async (text) => {
     var quot = [{"key": {"remoteJid": "status@broadcast","fromMe": false,"participant": "0@s.whatsapp.net"},"message": {"contactMessage": {"displayName": '𝐙𝐞𝐭𝐚-𝐗𝐃 ㋚',"vcard": "BEGIN:VCARD\nVERSION:3.0\nN:"+'ezraaaa'+"\nFN:"+'ezraaaa'+"\nitem1.TEL;waid=919747257996:919747257996\nitem1.X-ABLabel:Click To Chat\nitem2.EMAIL;type=INTERNET:GitHub: Zeta-X0\nitem2.X-ABLabel:Follow Me On Github\nitem3.URL:YouTube: illa\nitem3.X-ABLabel:Youtube\nitem4.ADR:;;India, Kerala;;;;\nitem4.X-ABLabel:Region\nEND:VCARD"}}}]
     let zeta = quot[Math.floor(Math.random()*quot.length)];
     let readMore = String.fromCharCode(8206).repeat(4001);
     await conn.sendMessage(msg.from, { text: text, contextInfo: { externalAdReply: {
     title: "𝐳𝐞𝐭𝐚𝐚𝐚𝐡𝐡 ࿊",
     body: "",
     sourceUrl: "",
     mediaUrl: "",
     ...
     thumbnailUrl: "https://i.imgur.com/rCB3S3B.jpeg" }},},{ quoted: zeta });
  }
