...
class King extends Base {
  ...
  _patch(data, msg) {
    ...
    this.key = data.key || {}; // Ensure key is always an object
    this.isGroup = data.isGroup;
    this.prefix = data.prefix;
    this.id = this.key.id || undefined; // Prevent reading 'id' from undefined
    ...
    this.message = msg?.message || {}; // Prevent undefined message
    this.timestamp =
      typeof data.messageTimestamp === "object"
        ? data.messageTimestamp?.low
        : data.messageTimestamp;
